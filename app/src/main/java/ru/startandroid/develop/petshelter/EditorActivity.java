...
import ru.startandroid.develop.petshelter.data.PetContract.PetEntry;
import ru.startandroid.develop.petshelter.data.ShelterDbHelper;
    ...
    private void savePet() {
        ...
        if (currentPetUri == null) {
            ...
            if (newUri == null) {
                ...
                Toast.makeText(this, "Update pet fail",
                        Toast.LENGTH_SHORT).show();
            } else {
                // Otherwise, the insertion was successful and we can display a toast.
                Toast.makeText(this, "Update pet success",
                        Toast.LENGTH_SHORT).show();
            }
        } else {
